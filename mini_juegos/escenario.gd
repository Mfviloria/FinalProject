...
func _determinar_minijuego():
	...
	match seccion:
		0.0:
			...
			get_tree().change_scene_to_file("res://mini_juegos/escenas/Turtle mini-game/Turtle mini-game/water.tscn")
		1.0:
			print("¡SELECCIONADO MINIJUEGO 2!")
			get_tree().change_scene_to_file("res://mini_juegos/control.tscn")
		2.0:
			print("¡SELECCIONADO MINIJUEGO 3!")
			get_tree().change_scene_to_file("res://mini_juegos/catching.tscn")

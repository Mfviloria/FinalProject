...
func win():
	$Trashtimer.stop()
	game_running = false
	get_tree().change_scene_to_file("res://escenas/Turtle mini-game/__MACOSX/Turtle mini-game/._WIN.tscn")
...
func _on_area_2d_body_entered(body: Node2D) -> void:
	get_tree().change_scene_to_file("res://escenas/Turtle mini-game/__MACOSX/Turtle mini-game/._LOse.tscn")

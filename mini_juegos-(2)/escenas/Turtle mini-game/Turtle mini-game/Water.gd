...
func win():
	...
	$Trashtimer.stop()
	game_running = false
	get_tree().change_scene_to_file("res://mini_juegos-(2)/escenas/Turtle mini-game/Turtle mini-game/WIN.tscn")
...
func _on_area_2d_body_entered(body: Node2D) -> void:
	...
	get_tree().change_scene_to_file("res://mini_juegos-(2)/escenas/Turtle mini-game/Turtle mini-game/LOse.tscn")
